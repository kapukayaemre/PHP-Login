...
<body class="<?php echo cook('color') ? cook('color') : 'bg-dark';  ?>">
    <div class="d-flex align-items-center justify-content-center p-4"><img height="" src="kodl.png" alt=""></div>
    <div class="container d-flex align-items-center justify-content-center">
        <div class="card <?php echo cook('color') ? cook('color') : 'bg-dark';  ?>" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <form action="islem.php?islem=hakkimda" method="post">
                    <textarea class="form-control <?php echo cook('color') ? cook('color') : 'bg-dark';  ?> text-primary" name="hakkimda" id="" cols="30"
