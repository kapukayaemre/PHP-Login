    ...
    <div class="card bg-dark" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <form action="islem.php?islem=giris" method="post">
                ...
                <input type="text" name="username" value="<?php echo session('username'); ?>" class="form-control">
                <label for="password" class="text-success">Şifreniz</label>
                <input type="text" name="password" value="<?php echo session('password'); ?>" class="form-control mb-4">
